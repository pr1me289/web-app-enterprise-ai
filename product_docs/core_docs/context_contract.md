...
| **Context Contract** | |
| | |
| _Illustrated with OptiChain as the Onboarding Candidate_ | |
+==========================================================+============================================================================================================+
...
idx_slack_notes (Procurement-scoped) --- No access --- No access ✓ Procurement threads only --- No access _--- Downstream-only; no index queries permitted_
